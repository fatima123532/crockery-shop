...
code = code.replace(/<div className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100 rounded-2xl p-4">[\s\S]*?<\/div>/, '');
code = code.replace(/<div className="p-3">\s*<div className="mt-3/g, '<div className="p-3 border-t border-slate-100">\n          <div className="mt-2');
